...
def get_predicted_value(patient_symptoms):
    ...
    for item in patient_symptoms:
        if item not in symptoms_dict:
            return "Invalid symptom detected. Please enter valid symptoms."
...
def home():
    if request.method == 'POST':
        ...
        if symptoms =="Symptoms":
            ...
            if "Invalid symptom detected" in predicted_disease:
                return render_template('results.html', message=predicted_disease)
